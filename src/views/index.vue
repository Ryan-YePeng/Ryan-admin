<template>
  <div class="index" ref="index" id="index" v-title data-title="admin-master">
    <el-container>
          ...
          <div class="navbar">
            ...
            <el-dropdown trigger="click" style="cursor: pointer">
              <div class="avatar-box">
                <el-avatar shape="square" :size="45" :src="`http://ylhy.online:8030/temp/${user.picture}`">
                  <img style="margin-top: 1px" src="https://myinterface.xuanzai.top/getPicture?type=error"/>
                </el-avatar>
